...
<center><p>Please wait, <?php echo $_SESSION['username']; ?>, <br /> while we log you in.</center>
<META HTTP-EQUIV="refresh" CONTENT="3"><br /></p>
...
<tr><td>
<input type="password" name="passwd" size="17" maxlength="50">
</td></tr>
